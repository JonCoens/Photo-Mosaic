...
"""
import numpy
from colormath_fast import color_conversions
from colormath_fast import color_constants
from colormath_fast import density
from colormath_fast.color_exceptions import *
from colormath_fast.color_diff import delta_e_cie2000, delta_e_cie1976, delta_e_cie1994, delta_e_cmc
...
#        self.has_required_values()
    ...
    def delta_e(self, other_color, mode='cie2000', *args, **kwargs):
        ...
        if not isinstance(self, LabColor):
            lab1 = self.convert_to('lab', *args, **kwargs)
        else:
            lab1 = self
        if not isinstance(other_color, LabColor):
